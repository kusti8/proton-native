...
var Renderer = Reconciler((_Reconciler = {
...
}, _defineProperty(_Reconciler, 'resetTextContent', function resetTextContent(instance) {
  console.log('resetTextContent');
}), _defineProperty(_Reconciler, 'createTextInstance', function createTextInstance(text, rootContainerInstance, hostContext, internalInstanceHandle) {
  console.log('createTextInstance');
  return text;
}), _defineProperty(_Reconciler, 'scheduleAnimationCallback', function scheduleAnimationCallback() {
  console.log('scheduleAnimationCallback');
}), _defineProperty(_Reconciler, 'scheduleDeferredCallback', function scheduleDeferredCallback() {
...
}), _defineProperty(_Reconciler, 'now', function now() {}), _defineProperty(_Reconciler, 'useSyncScheduling', true), _Reconciler));
